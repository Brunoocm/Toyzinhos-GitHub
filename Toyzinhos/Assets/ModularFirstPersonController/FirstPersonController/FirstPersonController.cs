...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.crouchHeight = EditorGUILayout.Slider(new GUIContent("Crouch Height", "Determines the y scale of the player object when crouched."), fpc.crouchHeight, .1f, 10f);
